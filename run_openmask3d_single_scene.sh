...
# data paths
SCENE_DIR="$(pwd)/resources/data_meeting_v2"
SCENE_POSE_DIR="${SCENE_DIR}/pose"
SCENE_INTRINSIC_PATH="${SCENE_DIR}/intrinsic/intrinsic_color.txt"
SCENE_INTRINSIC_RESOLUTION="[360,640]" # change if your intrinsics are based on another resolution
SCENE_PLY_PATH="${SCENE_DIR}/data_meeting_v2_mesh.ply"
